  ...
  const serviceItems = [
    {
      ...
      keyFeatures: [
        ...
        "Agreed Upon Procedures (APU)",
        "Limited Review",
        "CFO Services",
        "Expert Accounting Advisory",
    ...
    {
      id: "in-country",
      name: "In-Country Value",
      shortDescription:
        "Identify, assess, and mitigate business risks across your organization.",
      description:
        "The UAE’s National In-Country Value (ICV) program has completely reshaped the landscape of government and semi-government procurement. What started as an initiative by ADNOC has now become a national mandate under the Ministry of Industry and Advanced Technology (MoIAT)",
      detailedDescription:
        "At Insight Integrators, we don't just help you calculate your score—we help you engineer a higher one. We turn the ICV mandate from an administrative hurdle into a powerful competitive advantage that puts you at the front of the line for the UAE’s biggest tenders",
      keyFeatures: [
        "Local Supplier Identification, Assessment, and Development",
        "Economic Impact Measurement and Reporting ",
        "Independent Auditing and Verification of Local Content",
        "Procurement Strategy Development Services to Maximize Local Participation",
        "Training and Capacity Building Services for Local Businesses and Workforce",
  ...
  const industryData = [
    {
      ...
      services: [
        ...
        },
        {
          ...
          keyFeatures: [
            "Market Entry & Scalability Planning",
        ...
        },
        {
          ...
          keyFeatures: [
            "Employee Self-Service & Digital Records",
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {item.keyFeatures.map((feature, idx) => (
                            ...
                            >
                              ...
                              <span className="text-sm text-gray-600 font-light group-hover:text-gray-700 transition-colors">
                                {feature}
                              </span>
                            </div>
                          ))}
