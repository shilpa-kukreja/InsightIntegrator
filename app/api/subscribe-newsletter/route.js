...
//         JSON.stringify({
//           error:
//             "User consent is required for email marketing communications.",
//         }),
//         {
//           status: 400,
//           headers: {
...
//             <div class="field">
//               <div class="label">Consent Timestamp</div>
//               <div class="value">${subscribedAt}</div>
//             </div>
...
//           .header {
//             background: linear-gradient(135deg, #2c154f, #4a2477);
//             color: white;
//             padding: 40px 30px;
//             text-align: center;
//           }
...
//           <div class="header">
//             <h1>Welcome to Insight Integrators</h1>
...
//               We’re excited to share valuable business insights,
//               UAE compliance updates, accounting strategies,
//               and expert resources with you.
//             </p>

//             <p>You will receive:</p>

//             <ul class="features">
//               <li>✓ UAE Tax & VAT Updates</li>
//               <li>✓ Compliance & Accounting Insights</li>
//               <li>✓ Business Growth Strategies</li>
//               <li>✓ Exclusive Resources & Articles</li>
//               <li>✓ Event & Webinar Announcements</li>
//             </ul>
...
//               Best regards,<br />
//               <strong>Insight Integrators Team</strong>
//             </p>
...
//             <p>
//               You may unsubscribe at any time by replying to this email.
//             </p>

//             <p>
//               © ${new Date().getFullYear()} Insight Integrators.
//               All Rights Reserved.
//             </p>
  ...
  try {
    ...
    const subscriberMailOptions = {
      ...
      <div style="font-family:Arial;padding:20px;">
        ...
        <ul>
          <li>UAE Tax Updates</li>
          <li>Business Insights</li>
          <li>Compliance Updates</li>
          <li>Accounting Strategies</li>
        </ul>
